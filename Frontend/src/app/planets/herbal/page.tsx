      ...
      <div className="mx-auto w-container max-w-full px-5 py-[110px] text-center lg:py-[150px] relative">
        ...
        <div className="grid grid-cols-2 gap-y-8 mt-10" style={{ height: 'auto' }}>
          ...
          <div className="relative flex justify-center items-center">
            <Link href="/planets/herbal/floral" passHref>
          ...
          <div></div>
          <div className="relative flex justify-center items-center">
            <Link href="/planets/herbal/vegetal" passHref>
              <div className="relative w-full h-full"> {/* Rotation container */}
                <Image 
                  src="/earth1.jpg" 
                  alt="Second Planet" 
          ...
          <div className="relative flex justify-center items-center">
            <Link href="/planets/herbal/earthy" passHref>
              <div className="relative w-full h-full"> {/* Rotation container */}
                <Image 
                  src="/planet4.jpg" 
                  alt="Third Planet" 
          ...
          <div></div>
          <div className="relative flex justify-center items-center">
            <Link href="/planets/herbal/herb" passHref>
              <div className="relative w-full h-full"> {/* Rotation container */}
                <Image 
                  src="/mercury1.jpg" 
                  alt="Fourth Planet" 
