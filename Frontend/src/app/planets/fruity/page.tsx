      ...
      <div className="mx-auto w-container max-w-full px-5 py-[110px] text-center lg:py-[150px] relative">
        ...
        <div className="grid grid-cols-2 gap-y-8 mt-10" style={{ height: 'auto' }}>
          ...
          <div className="relative flex justify-center items-center">
            <Link href="/planets/fruity/citrus" passHref>
          ...
          <div></div>
          <div className="relative flex justify-center items-center">
            <Link href="/planets/fruity/apple" passHref>
              <div className="relative w-full h-full"> {/* Rotation container */}
                <Image 
                  src="/earth1.jpg" 
                  alt="Second Planet" 
          ...
          <div className="relative flex justify-center items-center">
            <Link href="/planets/fruity/pear" passHref>
              <div className="relative w-full h-full"> {/* Rotation container */}
                <Image 
                  src="/planet4.jpg" 
                  alt="Third Planet" 
          ...
          <div></div>
          <div className="relative flex justify-center items-center">
            <Link href="/planets/fruity/grape" passHref>
              <div className="relative w-full h-full"> {/* Rotation container */}
                <Image 
                  src="/mercury1.jpg" 
                  alt="Fourth Planet" 
          ...
          <div className="relative flex justify-center items-center">
            <Link href="/planets/fruity/tropical" passHref>
              <div className="relative w-full h-full"> {/* Rotation container */}
                <Image 
                  src="/planet3.jpg" 
                  alt="Fifth Planet" 
          ...
          <div></div>
          <div className="relative flex justify-center items-center">
              <Link href="/planets/fruity/stone" passHref>
              <div className="relative w-full h-full"> {/* Rotation container */}
                <Image 
                  src="/mercury1.jpg" 
                  alt="Fourth Planet" 
          ...
          <div className="relative flex justify-center items-center">
            <Link href="/planets/fruity/berry" passHref>
              <div className="relative w-full h-full"> {/* Rotation container */}
                <Image 
                  src="/planet3.jpg" 
                  alt="Fifth Planet" 
          ...
          <div></div>
          <div className="relative flex justify-center items-center">
            <Link href="/planets/fruity/dried" passHref>
              <div className="relative w-full h-full"> {/* Rotation container */}
                <Image 
                  src="/mercury1.jpg" 
                  alt="Fourth Planet" 
